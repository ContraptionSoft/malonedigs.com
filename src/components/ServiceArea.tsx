        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative flex items-center justify-center order-2 lg:order-1">
            <div
              ...
              style={{
                ...
                border: "1px solid rgba(59,174,174,0.2)",
                borderRadius: "2px",
              }}
            >
              ...
              >
                ...
                <path
                  ...
                  fill="rgba(59,174,174,0.08)"
                  stroke="rgba(59,174,174,0.4)"
                  strokeWidth="1.5"
                />
                {/* Benton / Central AR star */}
                <circle cx="110" cy="108" r="6" fill="#3BAEAE" opacity="0.9" />
                <circle cx="110" cy="108" r="12" fill="rgba(59,174,174,0.2)" />
                <circle cx="110" cy="108" r="20" fill="rgba(59,174,174,0.07)" />
                {/* Dot: Hot Springs */}
                <circle cx="90" cy="128" r="3" fill="rgba(59,174,174,0.5)" />
                {/* Dot: Little Rock */}
                <circle cx="120" cy="100" r="3" fill="rgba(59,174,174,0.5)" />
                {/* Dot: Conway */}
                <circle cx="112" cy="88" r="3" fill="rgba(59,174,174,0.5)" />
                {/* Dot: Fort Smith */}
                <circle cx="55" cy="100" r="3" fill="rgba(59,174,174,0.3)" />
                {/* Dot: Fayetteville */}
                <circle cx="62" cy="48" r="3" fill="rgba(59,174,174,0.3)" />
                {/* Dot: Jonesboro */}
                <circle cx="160" cy="50" r="3" fill="rgba(59,174,174,0.3)" />
                {/* Benton label */}
                <text x="118" y="112" fill="#3BAEAE" fontSize="9" fontFamily="sans-serif" fontWeight="bold">Benton</text>
              </svg>

              {/* Corner brackets */}
              <div className="absolute top-3 left-3" style={{ width: 16, height: 16, borderTop: "1.5px solid rgba(59,174,174,0.5)", borderLeft: "1.5px solid rgba(59,174,174,0.5)" }} />
              <div className="absolute top-3 right-3" style={{ width: 16, height: 16, borderTop: "1.5px solid rgba(59,174,174,0.5)", borderRight: "1.5px solid rgba(59,174,174,0.5)" }} />
              <div className="absolute bottom-3 left-3" style={{ width: 16, height: 16, borderBottom: "1.5px solid rgba(59,174,174,0.5)", borderLeft: "1.5px solid rgba(59,174,174,0.5)" }} />
              <div className="absolute bottom-3 right-3" style={{ width: 16, height: 16, borderBottom: "1.5px solid rgba(59,174,174,0.5)", borderRight: "1.5px solid rgba(59,174,174,0.5)" }} />
          ...
          <div className="order-1 lg:order-2">
            ...
            >
              SERVING ALL
              <br />
              <span style={{ color: "#3BAEAE" }}>OF ARKANSAS</span>
            </h2>
            <div
              className="mb-6"
